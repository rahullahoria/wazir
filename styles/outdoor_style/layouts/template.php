...
<body id="page" class="page <?php echo $this['config']->get('body_classes'); ?>" data-config='<?php echo $this['config']->get('body_config','{}'); ?>'>
	...
	<?php echo '<div class="licinfo"><a href="http://www.mightyjoomla.com/free-joomla-template">High Quality Free Joomla Templates</a> by <a href="http://www.mightyjoomla.com">MightyJoomla</a> | Design Inspiration <a href="http://www.freecsstemplates.org/">FCT</a></div>'; ?>
